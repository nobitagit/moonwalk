  ...
  "use strict";
	...
	var MoonwalkNav = (function(){
		...
		var nav = document.getElementById('Moonwalk-nav'),
			 ...
			 // events that fire the animation and open the menu
			 navEvts = ['mouseover','mouseleave'],
			 navEvts = {open : ['mouseover'], close: ['mouseleave']},
			 // events that toggle the menu on smaller screens where no hover is present
			 toggleEvts = ['click'],
